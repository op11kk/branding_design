...
const siteBackgroundVideo = document.querySelector(".site-background-video");

if (siteBackgroundVideo) {
  siteBackgroundVideo.addEventListener("loadedmetadata", () => {
    siteBackgroundVideo.playbackRate = 0.76;
  });

  if (reduceMotion.matches) {
    siteBackgroundVideo.autoplay = false;
