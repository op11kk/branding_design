...
const incomeTrigger = document.querySelector("[data-income-trigger]");
const incomeStatus = document.querySelector("[data-income-status] span");

incomeTrigger.addEventListener("click", () => {
  homeScene.classList.remove("is-earned");
  incomeTrigger.setAttribute("aria-pressed", "false");
  incomeStatus.textContent = "Tap EgoClip";

  requestAnimationFrame(() => requestAnimationFrame(() => {
    homeScene.classList.add("is-earned");
    incomeTrigger.setAttribute("aria-pressed", "true");
    incomeStatus.textContent = "Income received";
  }));
});
...
const sectionObserver = new IntersectionObserver((entries) => {
  ...
  const onHome = section.id === "home";
  chapterLabel.textContent = section.dataset.section;
  header.classList.toggle("on-home", onHome);
  header.classList.toggle("on-dark", section.dataset.theme === "dark");
  root.classList.toggle("home-active", onHome);
