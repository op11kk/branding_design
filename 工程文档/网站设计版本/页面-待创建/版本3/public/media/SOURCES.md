...
### Generated home environment

- `home/entryway-desktop-v1.jpg` and `home/entryway-mobile-v1.jpg` — generated on 2026-08-18 with the built-in image generation tool. The corresponding source PNG files are retained under `reference/generated/home/`. Both compositions intentionally reserve visual space for an interactive DOM object layered into the scene at runtime.
...
- `hero-water-master.mp4` and `hero-water-poster.jpg` — earlier UBL opening-page study, “Hand Holding Water” by cottonbro studio. Source: https://www.pexels.com/video/hand-holding-water-10678277/ . Licensed under the Pexels License. Kept for provenance and prior-version recovery; neither file is referenced by the current EgoClip page.
